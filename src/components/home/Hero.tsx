...
export default function Hero() {
  return (
    <section className="relative overflow-hidden pt-12 pb-20 gradient-mesh">
      {/* Layered gradient blobs */}
      <div className="pointer-events-none absolute -top-32 -right-32 w-[500px] h-[500px] rounded-full bg-gold/15 blur-3xl" />
      <div className="pointer-events-none absolute -bottom-40 -left-20 w-[420px] h-[420px] rounded-full bg-primary/10 blur-3xl" />
      <div className="pointer-events-none absolute top-1/3 left-1/4 w-[300px] h-[300px] rounded-full bg-primary-light/70 blur-3xl" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.15fr_1fr] gap-12 items-center">
            ...
            <Reveal delay={100}>
              <h1 className="display-title mb-5">
                ...
                <span className="relative text-primary inline-block">
                  آلمانی
                  <span className="absolute -bottom-1 inset-x-0 h-3 bg-gold/35 -z-10 rounded-full" />
                </span>
                <br />
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {stats.map((s, i) => (
                <Reveal key={s.lbl} delay={440 + i * 70}>
                  <div className="glass-card px-4 py-3 text-center transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_8px_24px_-8px_rgba(14,155,111,0.25)]">
                    <div className="text-2xl font-black text-primary leading-none">{s.num}</div>
          ...
          <Reveal delay={150} className="relative">
            ...
            <div className="glass-card p-7 shadow-2xl shadow-primary/10 relative">
              {/* Teacher profile */}
              <div className="flex items-center gap-4 mb-6">
                <div className="w-16 h-16 rounded-2xl overflow-hidden shadow-md flex-shrink-0">
                  <svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" width="64" height="64">
                    ...
                    <g clipPath="url(#rc)">
                      <rect width="64" height="21.3" y="0" fill="#16241f" />
                      <rect width="64" height="21.3" y="21.3" fill="#0e9b6f" />
                      <rect width="64" height="21.4" y="42.6" fill="#d4a94c" />
                    </g>
                  </svg>
                </div>
                <div>
                  <h3 className="font-black text-lg">میلاد قاسمی</h3>
                  <p className="text-primary text-sm font-semibold">مدرس زبان آلمانی</p>
                      ...
                      <Link
                        ...
                        className={`px-3 py-1.5 rounded-xl text-xs font-black border-2 transition-all hover:scale-105
                          ${lv === 'A1'
                            ...
                            : 'bg-white text-ink-soft border-line hover:border-primary hover:text-primary'}`}
                      >
                        {lv}
                      </Link>
                      {i < levels.length - 1 && (
              ...
              <div className="grid grid-cols-3 gap-3">
                {[
                  { icon: '🎬', val: '۱۲۰+', lbl: 'ویدیو' },
                  { icon: '📝', val: '۴۸+', lbl: 'تمرین' },
                  { icon: '🏆', val: '۲۴', lbl: 'درس' },
                ].map((m) => (
