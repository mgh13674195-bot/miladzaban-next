...
export const lesson2Exercises: Exercise[] = [
  ...
  // ── Exercise 5: Möbel & Zimmer beschreiben — sentence building ───
  {
    ...
    level: 'A2.1',
    lessonId: 2,
    instructionFa: 'با کلمات داده‌شده یک جمله‌ی کامل بسازید. می‌توانید فعل حالت ثابت (Wo? + Dativ) یا فعل حرکت (Wohin? + Akkusativ) به‌کار ببرید.',
    instructionDe: 'Bilden Sie mit den Wörtern einen vollständigen Satz.',
    explanationFa: 'برای حالت ثابت از stehen/liegen/hängen + Dativ، و برای حرکت از stellen/legen/hängen + Akkusativ استفاده کنید — هر دو شکل در این تمرین پذیرفته می‌شود.',
    items: [
      {
        id: '1',
        prompt: 'Lampe / auf / Tisch →',
        answer: ['Die Lampe steht auf dem Tisch.', 'Ich stelle die Lampe auf den Tisch.'],
        translationFa: 'چراغ روی میز قرار دارد. / من چراغ را روی میز می‌گذارم.',
      },
      {
        id: '2',
        prompt: 'Bild / an / Wand →',
        answer: ['Das Bild hängt an der Wand.', 'Ich hänge das Bild an die Wand.'],
        translationFa: 'تابلو روی دیوار آویزان است. / من تابلو را روی دیوار آویزان می‌کنم.',
      },
      {
        id: '3',
        prompt: 'Teppich / auf / Boden →',
        answer: ['Der Teppich liegt auf dem Boden.', 'Ich lege den Teppich auf den Boden.'],
        translationFa: 'فرش روی زمین است. / من فرش را روی زمین می‌گذارم.',
      },
      {
        id: '4',
        prompt: 'Kommode / zwischen / Türen →',
        answer: ['Die Kommode steht zwischen den Türen.', 'Ich stelle die Kommode zwischen die Türen.'],
        translationFa: 'کمد بین درها قرار دارد. / من کمد را بین درها می‌گذارم.',
      },
      {
        id: '5',
        prompt: 'Sofa / vor / Wand →',
        answer: ['Das Sofa steht vor der Wand.', 'Ich stelle das Sofa vor die Wand.'],
        translationFa: 'مبل جلوی دیوار قرار دارد. / من مبل را جلوی دیوار می‌گذارم.',
      },
      {
        id: '6',
        prompt: 'Spiegel / an / Wand →',
        answer: ['Der Spiegel hängt an der Wand.', 'Ich hänge den Spiegel an die Wand.'],
        translationFa: 'آینه روی دیوار آویزان است. / من آینه را روی دیوار آویزان می‌کنم.',
      },
    ],
  },
]
