...
export const a2Lessons: A2Lesson[] = [
...

  {
    ...
    shortDescription: 'بیماری و بدن، حادثه و اورژانس، بیان نگرانی و امیدواری، جمله با weil/deshalb/denn.',
    duration: '۵۵ دقیقه',
    tags: ['سلامتی', 'گرامر', 'مکالمه'],
    lessonVideos: buildCoursebookVideos(8, 5), workbookVideos: buildWorkbookVideo(8),
    pdfUrl: PDF_PLACEHOLDER, audioUrl: AUDIO_PLACEHOLDER, exercisesUrl: EX_PLACEHOLDER,
    vocabulary: [
      { de: 'das Herz / der Magen', fa: 'قلب / معده' },
      { de: 'Schmerzen haben', fa: 'درد داشتن' },
      { de: 'der Notarzt / der Krankenwagen', fa: 'پزشک اورژانس / آمبولانس' },
      { de: 'die Notaufnahme', fa: 'بخش اورژانس' },
...

  {
    ...
    shortDescription: 'زندگی کاری، شرکت و تولید، بیان اهمیت در شغل، صفت بدون حرف تعریف.',
    duration: '۴۵ دقیقه',
    tags: ['کار', 'گرامر', 'لغت'],
    lessonVideos: buildCoursebookVideos(9, 4), workbookVideos: buildWorkbookVideo(9),
    pdfUrl: PDF_PLACEHOLDER, audioUrl: AUDIO_PLACEHOLDER, exercisesUrl: EX_PLACEHOLDER,
    vocabulary: [
      { de: 'der Arbeiter / die Angestellte', fa: 'کارگر / کارمند' },
      { de: 'der Lohn', fa: 'حقوق / دستمزد' },
      { de: 'die Firma / der Betrieb', fa: 'شرکت' },
      { de: 'der Import / der Export', fa: 'واردات / صادرات' },
...

  {
    ...
    shortDescription: 'رفتن به رستوران، سفارش دادن، شکایت کردن، حساب کردن، جمله‌های dass.',
    duration: '۴۰ دقیقه',
    tags: ['رستوران', 'گرامر', 'مکالمه'],
    lessonVideos: buildCoursebookVideos(10, 5), workbookVideos: buildWorkbookVideo(10),
    pdfUrl: PDF_PLACEHOLDER, audioUrl: AUDIO_PLACEHOLDER, exercisesUrl: EX_PLACEHOLDER,
    vocabulary: [
      { de: 'das Besteck / das Geschirr', fa: 'قاشق‌چنگال / ظرف‌ها' },
...

  {
    ...
    shortDescription: 'بازیافت و Second-Hand، ایده‌ی تجاری، تبریک و تشکر، فعل‌های انعکاسی.',
    duration: '۵۰ دقیقه',
    tags: ['گرامر', 'مکالمه', 'لغت'],
    lessonVideos: buildCoursebookVideos(11, 4), workbookVideos: buildWorkbookVideo(11),
    pdfUrl: PDF_PLACEHOLDER, audioUrl: AUDIO_PLACEHOLDER, exercisesUrl: EX_PLACEHOLDER,
    vocabulary: [
      { de: 'sich freuen / sich ärgern', fa: 'خوشحال شدن / ناراحت شدن' },
      { de: 'der Rucksack / die Geldbörse', fa: 'کوله‌پشتی / کیف پول' },
      { de: 'aus altem Stoff', fa: 'از پارچه‌ی کهنه' },
...

  {
    ...
    shortDescription: 'مواد غذایی، عادت‌های غذایی، آمار تغذیه، بیان تعجب، جمله‌های wenn.',
    duration: '۶۰ دقیقه',
    tags: ['تغذیه', 'گرامر', 'مکالمه'],
    lessonVideos: buildCoursebookVideos(12, 6), workbookVideos: buildWorkbookVideo(12),
    pdfUrl: PDF_PLACEHOLDER, audioUrl: AUDIO_PLACEHOLDER, exercisesUrl: EX_PLACEHOLDER,
    vocabulary: [
      { de: 'das Obst / das Gemüse', fa: 'میوه / سبزیجات' },
      { de: 'durchschnittlich / rund', fa: 'به‌طور متوسط / حدوداً' },
      { de: 'Wenn es warm ist, …', fa: 'وقتی هوا گرم است، …' },
      { de: 'Es überrascht mich, dass …', fa: 'برایم تعجب‌آور است که …' },
      { de: 'In meiner Heimat …', fa: 'در کشور من …' },
    ],
    sampleComments: [
